...
public class Parse {
	...
	public static void parsePageApps(String pageAppJson) {
		if (TextUtils.isEmpty(pageAppJson)) {
			L.d("returned by pageAppJson is empty when parsePageApps");
			return;
		}
		DataCenter dataCenter = DataCenter.getInstance();
		if (dataCenter.getCategories() == null || dataCenter.getCategories().size() == 0) {
			L.d("returned by dataCenter.getCategories() is empty when parsePageApps");
			return;
		}
		try {
	...
	public static List<App> parseCategoryApp(String categoryAppJson) {
